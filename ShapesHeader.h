#ifndef SHAPESHEADER_H  //If the compiler has already defined this header file, this line keeps it from repeating the process.
#define SHAPESHEADER_H  //Puts DYERJOHNHMONEY_H on a list to indicate that it has been seen and allows compiler to skip over rest of file to #endif
